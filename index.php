...
function ads_stl_admin_scripts(): void {
  wp_enqueue_style('ads-stl-style', STL_PLUGIN_URL . 'assets/css/custom.css', false, '1.2');
  wp_enqueue_script('ads-stl-js', STL_PLUGIN_URL . 'assets/js/admin.js', false, '1.3', true);
}
